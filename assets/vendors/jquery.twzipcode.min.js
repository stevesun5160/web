...
(function (g, n, p, q) {
  ...
  m.prototype = {
    ...
    destroy: function () {
      ...
      if (this.container.length)
        return this.container
          .empty()
          .off("change.twzipcode keyup.twzipcode blur.twzipcode");
    },
    get: function (a) {
      function b(b) {
      ...
      "function" === typeof a
        ? a.call(
            this,
            this.wrap.county.val(),
            this.wrap.district.val(),
            this.wrap.zipcode.val(),
          )
        : "string" === typeof a
          ? a.split(",").forEach(b)
          : Array.isArray(a)
    ...
    set: function (a) {
      var b = g.extend({}, { county: "", district: "", zipcode: "" }, a);
      try {
        "string" === typeof a || "number" === typeof a
          ? this.wrap.zipcode.val(a).trigger("blur.twzipcode")
          : (b.zipcode &&
              this.wrap.zipcode.val(b.zipcode).trigger("blur.twzipcode"),
            b.county &&
              this.wrap.county.val(b.county).trigger("change.twzipcode"),
            b.district &&
              this.wrap.district.val(b.district).trigger("change.twzipcode"));
      } catch (c) {
        ...
        default:
          ...
          for (e in f)
            "undefined" !== typeof f[e] &&
              -1 === d.hideCounty.indexOf(e) &&
              l.push('<option value="' + e + '">' + e + "</option>");
    ...
    bindings: function () {
      ...
      c.county.on("change.twzipcode", function () {
        ...
        if (k) {
          if (!0 === b.zipcodeIntoDistrict)
            for (h in f[k])
              "undefined" !== typeof f[k][h] &&
                -1 === b.hideDistrict.indexOf(h) &&
                -1 === b.hideDistrict.indexOf(f[k][h]) &&
                (e.push('<option value="' + h + '">'),
                e.push(f[k][h] + " " + h),
                e.push("</option>"));
          else
            for (h in f[k])
          ...
          c.county.find("option:first").prop("selected", !0),
            a.reset("district");
      ...
      c.district.on("change.twzipcode", function () {
        ...
        "function" === typeof b.onDistrictSelect &&
          b.onDistrictSelect.call(this);
      });
      ...
      d =
        "undefined" !== typeof b.zipcodeSel
          ? b.zipcodeSel
          : "undefined" !== typeof a.role.zipcode.data("value")
            ? a.role.zipcode.data("value")
            : b.zipcodeSel;
      e =
        "undefined" !== typeof b.countySel
          ? b.countySel
          : "undefined" !== typeof a.role.county.data("value")
            ? a.role.county.data("value")
            : b.countySel;
      l =
        "undefined" !== typeof b.districtSel
          ? b.districtSel
          : "undefined" !== typeof a.role.district.data("value")
            ? a.role.district.data("value")
            : b.districtSel;
      e &&
        (a.wrap.county.val(e).trigger("change.twzipcode"),
        "undefined" !== typeof f[e][l] &&
          a.wrap.district.val(l).trigger("change.twzipcode"));
      d &&
        3 === d.toString().length &&
        a.wrap.zipcode.val(d).trigger("blur.twzipcode");
    },
      ...
      c &&
        ...
        c.getCurrentPosition(
          function (c) {
            var e = {};
            "coords" in c &&
              "latitude" in c.coords &&
              "longitude" in c.coords &&
              ((e = [c.coords.latitude, c.coords.longitude]),
              g.getJSON(
                "https://maps.googleapis.com/maps/api/geocode/json",
                { key: d.googleMapsKey, sensor: !1, latlng: e.join(",") },
                function (d) {
                  d &&
                    "undefined" !== typeof d.results &&
                    "undefined" !== typeof d.results[0].address_components &&
                    "undefined" !== typeof d.results[0].address_components[0] &&
                    (d =
                      d.results[0].address_components[
                        d.results[0].address_components.length - 1
                      ].long_name) &&
                    b.wrap.zipcode.val(d.toString()).trigger("blur.twzipcode");
    ...
    init: function () {
      ...
      g("<select/>")
        ...
        .addClass(
          c.county.data("style") ||
            ("undefined" !== typeof b.css[0] ? b.css[0] : ""),
        )
        .appendTo(c.county.length ? c.county : a);
      g("<select/>")
        .attr("name", e)
        .addClass(
          c.district.data("style") ||
            ("undefined" !== typeof b.css[1] ? b.css[1] : ""),
        )
        .appendTo(c.district.length ? c.district : a);
      g("<input/>")
        .attr({ type: "text", name: f, placeholder: k })
        .prop("readonly", h)
        .addClass(
          c.zipcode.data("style") ||
            ("undefined" !== typeof b.css[2] ? b.css[2] : ""),
        )
        .appendTo(c.zipcode.length ? c.zipcode : a);
      this.wrap = {
  ...
  g.fn.twzipcode = function (a) {
    ...
    return "string" === typeof a
      ? (this.each(function () {
          ...
          b instanceof m &&
            "function" === typeof b[a] &&
            (c = b[a].apply(b, Array.prototype.slice.call(d, 1)));
        }),
        "undefined" !== typeof c ? c : this)
      : this.each(function () {
          g.data(this, "twzipcode") ||
            g.data(this, "twzipcode", new m(this, a));
        });
  };
